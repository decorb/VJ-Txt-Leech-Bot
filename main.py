...
async def start(bot: Client, m: Message):
    await m.reply_text(f"<b>Hello {m.from_user.mention} 👋\n\n I Am A Bot For Download Links From Your **.TXT** File And Then Upload That File On Telegram So Basically If You Want To Use Me First Send Me /bhayyaji Command And Then Follow Few Steps..\n\nUse /stop to stop any ongoing task.</b>")
...
@bot.on_message(filters.command(["bhayyaji"]))
