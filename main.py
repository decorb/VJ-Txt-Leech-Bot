...
async def start(bot: Client, m: Message):
    await m.reply_text(
        f"<b>𝐇𝐞𝐥𝐥𝐨 𝐃𝐞𝐚𝐫 👋! {m.from_user.mention} \n\n"
...
async def upload(bot: Client, m: Message):
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            try:
                cc = (f'**[📽️] Vid_ID:** {str(count).zfill(3)}.** {name1} @CHAT_WITH_SAMEER_BOT.mkv \n\n'
                      f'**📚 𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘​ ➥ ** » **{raw_text0}**\n\n'
                      f'📥 𝗘𝗫𝗧𝗥𝗔𝗖𝗧𝗘𝗗 𝗕𝗬 **╰┈➤** ❝{raw_text3} ❞**\n\n'
                      f'❖──────𝗦𝗔𝗠𝗘𝗘𝗥 𝗝𝗜♡──────❖')
                cc1 = (f'**[📁] Pdf_ID:** {str(count).zfill(3)}. {name1} @CHAT_WITH_SAMEER_BOT.pdf  \n\n'
                       f'**📚 ​𝗕𝗔𝗧𝗖𝗛 𝗡𝗔𝗠𝗘​ ➥ **{raw_text0}**\n\n'
                       f'📥 𝗘𝗫𝗧𝗥𝗔𝗖𝗧𝗘𝗗 𝗕𝗬 **╰┈➤** ❝{raw_text3} ❞ **\n\n'
                       f'❖──────𝗦𝗔𝗠𝗘𝗘𝗥 𝗝𝗜♡──────❖')
                if "drive" in url:
